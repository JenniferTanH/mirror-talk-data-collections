...
laughs = ['haha', 'hahaha']
NAME = ["OBAMA", "MICHELLE OBAMA", "M", "Michelle Obama"]
...
def SpecialHandle():
    csv_file = open("csv/" + "President-Obama-interview.csv", 'w')
    writer = csv.writer(csv_file)
    writer.writerow(["name", "line"])
    with open("data/Special-Handle/President-Obama-interview.txt", 'r') as f:
        name = ""
        while 1:
            line = f.readline()
            ...
            if line.startswith("FIRST LADY MICHELLE OBAMA"):
                name = Interviewee
            elif line.startswith("PRESIDENT BARACK OBAMA"):
                name = "Interviewer"
